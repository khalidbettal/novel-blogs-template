...
function Article() {
  return (
    <div className="container my-24 mx-auto md:px-6 bg-gray-900 ">
      <section className="mb-32 text-center">
       
    
        <div className="grid gap-6 lg:grid-cols-3 xl:gap-x-12">
          <div className="mb-6 lg:mb-0 cursor-pointer border border-purple-600 pb-9 rounded-lg hover:bg-gray-800 p-2">
          ...
          <div className="mb-0  cursor-pointer border border-purple-600 pb-9 rounded-lg hover:bg-gray-800 p-2">
            <div>
              <div className="relative mb-6 overflow-hidden rounded-lg bg-cover bg-no-repeat shadow-lg dark:shadow-black/20"
                data-te-ripple-init data-te-ripple-color="light">
