...
function ContactUs() {
  return (
<div className="container pt-24 mx-auto md:px-6 bg-gray-900">
  <section className="pb-20">
    ...
    <div className=" px-6 md:px-12">
      <div
        className="block rounded-lg bg-[hsla(0,0%,100%,0.7)] px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-[hsla(0,0%,5%,0.7)] dark:shadow-black/20 md:py-16 -mt-[100px] backdrop-blur-[30px]">
